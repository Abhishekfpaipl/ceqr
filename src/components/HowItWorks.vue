  ...
  data() {
    return {
      ...
      steps: [
        ...
        {
          "title": "Set Up Your ceqr",
          "description": "Customize and list your ceqr offerings with interactive features like contact details, social links, and branding."
        },
        {
          "title": "Start Receiving Orders",
          "description": "Get orders from clients looking for personalized ceqr solutions to enhance their networking and branding."
        },
        {
          "title": "Easy Sharing",
          "description": "ceqrs can be shared instantly via QR codes, links, or social media, increasing visibility and reach."
        },
        {
