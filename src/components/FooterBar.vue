<template>
    <div class="container-fluid text-white pt-3 footer-container"
        style="background-color: var(--bg-primary) !important;">
        <div class="row pt-3">
            <div class="col-12 col-md-4 mb-3 d-flex flex-column align-items-center justify-content-start">
                ...
                <p class="mt-2 px-2 text-uppercase"> ceqr </p>
            </div>

            <div class="col-12 col-md-4 mb-3 text-center">
                <p class="mb-2 fw-bold">Contact Us</p>
                <p class="mb-2">Email: support@ceqr.com</p>
